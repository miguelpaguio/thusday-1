	...
	public void initialize(SEResourceCache rsc)
	 {
		...
		//fg.move(100,100);
		rsc.prepare_font("PogiSiIyano","arial bold color=white", 40);
		display = "BOUNCES = %d".printf().add(Primitive.for_integer(bounce)).to_string();
		text = add_sprite_for_text("BOUNCING RECTANGLE", "PogiSiIyano");
		text.move(0,get_scene_height()-text.get_height());
		rsc.prepare_image("myImage", "logo_ust", get_scene_width()*0.1);
